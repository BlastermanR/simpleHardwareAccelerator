...
set_property IOSTANDARD LVCMOS33 [get_ports -of_objects [get_iobanks 13]]; {SDA}] ; # I2C Data Pin (SDA)
#set_property PACKAGE_PIN R17 [get_ports {SCL}] ; # I2C Clock Pin (SCL)
#set_property IOSTANDARD LVCMOS33 [get_ports {SDA, SCL}] ; # Use LVCMOS33 I/O standard for I2C
